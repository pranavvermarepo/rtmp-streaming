...
**Description:** This endpoint starts processing a video stream. You can provide either a recorded video file or an RTMP URL as the input.it generates a unique stream id , saves manifest files in output folder and saves logs file.
